...
public class Game {
    ...
    private Platform [] yellowPlatform;
    ...
    public Game(double width, double height) {
        ...
        this.yellowPlatform = new Platform [1];
     ...
     * @param timeDelta
     */
    public void updateBubbles(LinkedList<Bubble> bubblescall,double timeDelta) {
        for (Bubble bubbleset : bubblescall)  bubbleset.update(bubbleset, timeDelta);
    ...
    public Platform getYellowPlatform() {
        return yellowPlatform[0];
    }
    ...
    public boolean isJellyfishOnPlatform(){
